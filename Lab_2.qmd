...
**Objective:** Add a data layer to a new map and start visualizing patterns
...
1.  Sign in to your [ArcGIS organizational account](https://www.arcgis.com/home/signin.html) or into ArcGIS Enterprise using a named user account.

> **Note:** If you don't have an organizational account, [see options for software access](https://learn.arcgis.com/en/become-a-member/).
