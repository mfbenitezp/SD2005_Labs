...
9.  **Drag and drop** your file or choose **Device** option and select the filtered Excel file (e.g., `1_1_1_indicator_filtered.csv`)
...
**NOTE**: If that does not work and Georgia point is still located in the USA. We need to Edit the layer and do it manually, unfortunately this can be a bug or glitch in the system and is very common when you work with these type of tool, so you need to adapt and find alternative solutions.
